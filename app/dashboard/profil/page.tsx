...
export default function ProfilePage() {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8">
      ...
      <div className="card overflow-hidden shadow-xl shadow-gray-200/50">
        ...
        <form onSubmit={handleSave} className="pt-16 pb-8 px-8 space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-[10px] text-gray-400">Gelar akan ditampilkan setelah nama di Top Bar.</p>
            </div>

            {/* Email (Read Only) */}
            <div className="space-y-2 opacity-60">
              <label className="text-sm font-bold text-gray-700 flex items-center gap-2">
                <Briefcase className="w-4 h-4 text-gray-400" /> Email Akun
              </label>
              <input
                type="email"
             ...
             <div className="space-y-2 opacity-60">
              <label className="text-sm font-bold text-gray-700 flex items-center gap-2">
                <Briefcase className="w-4 h-4 text-gray-400" /> Unit / Divisi
              </label>
              <input
                type="text"
          ...
          <div className="pt-4 border-t border-gray-100 flex justify-end">
            <button
              type="submit"
              disabled={loading}
              className="btn-primary px-8 py-2.5 flex items-center gap-2 shadow-lg shadow-blue-200"
            >
              {loading ? (
      ...
      <div className="card p-6 bg-blue-50 border-blue-100 flex items-start gap-4">
        <div className="p-2 bg-white rounded-lg shadow-sm">
          <InfoRowIcon />
        </div>
        <div>
          <h4 className="text-sm font-bold text-blue-900">Informasi Keamanan</h4>
